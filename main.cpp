...
void drawstringColor(int x, int y, char *s)
{
	char *c;
...
glPointSize(2.0);
drawstring(20,475,"Project by Sonal 1DT19CS154 and Srinidhi 1DT19CS158");
...
void earth()
{
    ...
    glColor3f(0,1,0.3);
    glBegin(GL_POLYGON);
    glVertex2f(150,290); //green part of earth
    glVertex2f(140,280);
    glVertex2f(145,270);
    glVertex2f(155,260);
    glVertex2f(165,265);
...
void orbit3() //after splitting into sat
{
glColor3f(1.0f, 1.0f, 1.0f);
glEnable(GL_LINE_SMOOTH);
//glLineWidth(5.0);
...
glVertex2f(82,250);
glEnd();
drawstringColor(textXCor,textYCor,"ROCKET");
    }
//glutSwapBuffers();
else{
if(a==t+5){
...
void satellite()
{
  ...
  //  glRotatef(340,0,0,1);
    ...
    glVertex2f(x+50,y+140);
    glEnd();
    drawstringColor(x+25,y+150,"SAT - MOM");
    drawstringColor(x+25,y+150,"SAT - MOM");
